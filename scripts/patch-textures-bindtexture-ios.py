...
new = (
    ...
    "\t// TU 1.2.2 ships at Common/res/1_2_2/ with the proper updated\n"
    "\t// atlas (e.g. 256x512 terrain.png with alpha in the grass_side\n"
    "\t// overlay slot, plus moon_phases.png, cavespider etc.). The\n"
    "\t// base Common/res/<rel>.png is the TU0 fallback and lacks those\n"
    "\t// later additions. TitleUpdate/res/ overrides everything when\n"
    "\t// present. Without this order the older atlas wins and TU 1.2.2\n"
    "\t// features (biome-tinted grass side, etc.) silently break.\n"
