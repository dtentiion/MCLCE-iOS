...
new = (
    ...
    "\t}\n"
    "\t// TU 1.2.2 assets (terrain/moon_phases.png, mob/cavespider, etc.)\n"
    "\t// live under Common/res/1_2_2/ on iOS where we don't run 4J's\n"
    "\t// tubuild flatten step. Try that path as a final fallback so\n"
    "\t// bindTexture doesn't silently fail and leave the previous\n"
    "\t// texture bound (which made the moon render as a slice of the sun).\n"
    "\tif (id == 0) {\n"
