...
// ETelemetryChallenges + the death-source enumerators are folded into
// the enum in iOS_stdafx.h since ServerPlayer.cpp assigns death-source
// values directly to a field of ETelemetryChallenges type.
